...
/*
 * This is a sample Java application that utilizes JNDI to access Active Directory 
 * and retrieves group membership of a user. This application uses computed tokenGroups 
 * attribute of a user object in order to get complete list of groups a user belongs to, 
 * including membership acquired through nested groups and built-in groups (ex. Domain Users).
 */
...
public class ADGroupMember	{
	public static void main (String[] args)	{
		...
		String adminName = "CN=FEMA-SVC-bobjsvc1,OU=ServiceAccounts,OU=MW,DC=fema,DC=net";
		String adminPassword = "CW0=8ofa";
		String ldapURL = "ldap://MWEI8C7.fema.net:389";
		...
		try {
			...
			String userSearchBase = "CN=FEMA-SVC-bobjsvc1,OU=ServiceAccounts,DC=fema,DC=net";
