...
import org.slf4j.LoggerFactory;
	...
	public class LDAPGroupAuthenticator {
		...
		private final static Logger Log = LoggerFactory.getLogger(LDAPGroupAuthenticator.class);
	    ...
	    public static boolean authenticate(String domain, String username, String password) {
	        ...
	        String groupDistinguishedName = "ou=Group,ou=BusinessObjectsDisaster,ou=system";
